# /// script
# requires-python = ">=3.9"
# dependencies = ["numpy", "matplotlib", "pypulseq==1.5.0.post1"]
#
# [tool.anyfield]
...
def fluid_suppressed_MRI(
    ...
    tr: float = 12e-3,
    te: float | None = 5e-3,
    fluid_suppression: bool = True,
    TI : float | None = 0.7e-3,
    ...
    fluid_suppression : bool, optional
        Whether to apply fluid suppression. Default is True.
    TI : float or None, optional
        Inversion time in seconds. Use ``None`` for default TI. Default is 0.7e-3.
